...
public class AppUtils {
    ...
    private static final String TAG = "App Demo";
    public static String KEY_PATH_INTENT = "path";
    ...
    // effectType from 200 (/300 = 0) is filter (200,201,202,...)
    // effect Type from 300 (/300 = 1) is enhance (300,301,302,...)
    // val is value in seek bar for every type
