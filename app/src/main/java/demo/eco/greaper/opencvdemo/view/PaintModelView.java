...
public class PaintModelView extends View{
    ...
    public PaintModelView(Context context) {
        super(context);
        initView(context);
    }

    public PaintModelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public PaintModelView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public PaintModelView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
