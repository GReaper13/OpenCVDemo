package demo.eco.greaper.opencvdemo.font;
...
public class FontPickerDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        title.setText("Select a font");
        title.setTextSize(TypedValue.COMPLEX_UNIT_SP, 22);
        title.setTextColor(ContextCompat.getColor(mContext, R.color.white));
        title.setPadding(16, 16, 16, 16);

        titleLinearLayout.setBackgroundColor(ContextCompat.getColor(mContext, R.color.colorAccent));
